  ...
  return (
   <div >
    ...
    <img   src={imageImport?.errorLogoGif} alt="paymentSuccessImage"  />
          ...
          <div className="text-algin-center">
          <Typography id="modal-modal-description" sx={{ fontSize:15,mt: -3,fontWeight:500 }}>{props.message}<a href={editable_config.TermAndServiceLink} target='_blank' ><span style={{color:palette.primary.main,fontSize:13}} > Learn more</span></a> </Typography>
          </div>
         <div className='text-algin-center confirm-button-popup ' >
          ...
          <a href={editable_config.ImageCompressorLink} target="_blank">
          <LoadingButton
          onClick={props.onYes}
         loading={props.loading}
         loadingPosition="start"
         startIcon={<Iconify icon="fluent:resize-image-20-filled" />} 
         variant="contained"
