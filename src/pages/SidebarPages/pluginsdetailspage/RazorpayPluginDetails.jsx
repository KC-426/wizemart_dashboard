...
<LoadingSpinner loading={pageLoading} />
 ...
 <Button style={{visibility:'hidden'}} onClick={handleOpenVideoModal} variant="text" className='image-guide-btn-text' startIcon={<Iconify icon="logos:youtube-icon" />}>Learn How it Works</Button>
</div>
<Paper elevation={4} >
