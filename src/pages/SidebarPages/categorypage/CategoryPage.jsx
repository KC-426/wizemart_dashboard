...
function CategoryPage({handleClose}) {
...
const handleTabChange = (event: React.SyntheticEvent, newValue: number) => {
  ...
  return (
    <>
    <VideoModal title='Learn how to add categories ?' video_url="https://www.youtube.com/embed/USccSZnS8MQ" isOpen={openVideoModal} handleClose={handleCloseVideoModal} /> 

     <div className="banner-image-guide-box order_page_video" style={{visibility:'hidden'}} >
