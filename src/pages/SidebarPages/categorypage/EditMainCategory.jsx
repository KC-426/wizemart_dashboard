...
console.log("FILE UPLOAD ___________",fileUpload)
 ...
 {/* #################### LOADING SPINNNER ######################## */}
     ...
     <PopupModal handleClose={handleClosePopupModal}open={openPopupModal} data={<ImageError handleClose={handleClosePopupModal} onYes={onYesFunction}  confirmBtnName='Image Compress Now' title='Reduce Image Size!! ' message='Max category image upload size is 200kb. For more read our image upload guidelines.'  />} />
        {/*===== IMAGE SIZE ERROR Popup Modal ====== */}
       {/*===== Popup Modal ====== */}
