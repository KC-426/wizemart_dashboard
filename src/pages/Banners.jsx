...
function handleOpenVideoModal(){
  ...
  return (
    <>
    <VideoModal title='Learn how to add your banners?' video_url="https://www.youtube.com/embed/ykOErWNr0kQ" isOpen={openVideoModal} handleClose={handleCloseVideoModal} /> 
