...
const handleChange = (event: React.SyntheticEvent, newValue: number) => {
  ...
  return (
    <>
    <VideoModal title='Learn how to go through your settings?' video_url="https://www.youtube.com/embed/GvE2rz-FVMo" isOpen={openVideoModal} handleClose={handleCloseVideoModal} /> 
